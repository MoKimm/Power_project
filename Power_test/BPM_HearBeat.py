...
# Define the total duration for one heartbeat cycle in seconds
heartbeat_duration = seconds_per_beat

# Calculate sample rate based on the length of the heartbeat pattern array
# This determines how long to wait between sending each voltage value to the DAC
def calculate_sample_rate(scaled_hbp_length, total_duration):
    return total_duration / scaled_hbp_length
...
try:
    while True:
        ...
        sample_rate = calculate_sample_rate(len(scaled_hbp), heartbeat_duration)
